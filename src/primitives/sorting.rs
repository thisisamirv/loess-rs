//! Sorting utilities for LOESS input data.
//!
//! ## Purpose
//!
...
//! 2. **Process**: LOESS smoothing operates on the sorted sequence.
...
//! ## Non-goals
//!
//! * This module does not perform data validation or LOESS calculation.
//!
