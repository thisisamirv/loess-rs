...
def plot_gap_handling():
    ...
    ax.set_title('LOESS Gap Handling (Bridging Missing Regions)', fontsize=14, fontweight='bold')
    ax.set_xlabel('x')
    ax.set_ylabel('y')
...
def plot_streaming_comparison():
    ...
    ax.set_title('Streaming LOESS: Comparison of Merge Strategies', fontsize=14, fontweight='bold')
...
def plot_online_comparison():
    ...
    ax.set_title('Online LOESS: Incremental Smoothing with Sliding Window', fontsize=14, fontweight='bold')
