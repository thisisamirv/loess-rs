...
```bash
# Clone and branch
git clone https://github.com/thisisamirv/loess-rs.git
cd loess-rs
...
`loess-rs` follows a layered architecture to prevent circular dependencies:
